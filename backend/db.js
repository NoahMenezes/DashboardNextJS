...
if (!url) {
  ...
  console.error("TURSO_DATABASE_URL=your-database-url");
      ...
      const blogPosts = [
        {
          ...
          content:
            "<h1>Choosing the Right Tech Stack</h1><p>In 2025, the landscape of web development has evolved...</p><p>Consider factors like scalability, community support, and performance.</p>",
        },
        {
          title:
            "Software Development Practices in 2025 - A guide to improve your software workflows",
          category: "Development",
          date: "April 3, 2025",
          readTime: "4 mins read",
          image:
            "https://images.unsplash.com/photo-1635776062127-d379bfcbb9f8?q=80&w=1000&auto=format&fit=crop",
          content:
            "<h1>Software Development Best Practices</h1><p>Agile, DevOps, and CI/CD are more critical than ever.</p>",
        },
        {
          title:
            "Modern Tech Services: Transforming Businesses for the Digital Age",
          category: "Technology",
          date: "April 3, 2025",
          readTime: "4 mins read",
          image:
          ...
          content:
            "<h1>Digital Transformation</h1><p>How modern services are reshaping traditional business models.</p>",
        },
        {
          title:
            "The Future of AI in SaaS: What to Expect in the Coming Decade",
          category: "AI & Trends",
          date: "April 2, 2025",
          ...
          content:
            "<h1>AI in SaaS</h1><p>Artificial Intelligence is becoming the backbone of Software as a Service...</p>",
        },
        {
          ...
          content:
            "<h1>UI Trends for 2026</h1><p>Glassmorphism, Neomorphism, and beyond. Preparing for the next wave of design.</p>",
        },
      ];

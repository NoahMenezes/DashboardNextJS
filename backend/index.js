...
const googleClientId = process.env.GOOGLE_CLIENT_ID || "612878658844-2kegk8lptok4k091024l39i7bduup1s7.apps.googleusercontent.com";
...
app.get('/api/users', async (req, res) => {
    try {
        const result = await db.execute("SELECT id, first_name as firstName, last_name as lastName, email, created_at FROM users ORDER BY created_at DESC");
...
app.post('/api/auth/google', async (req, res) => {
    ...
    try {
        ...
        if (existing.rows.length > 0) {
            ...
            user = { id: userId, first_name: given_name, last_name: family_name, email };
        }

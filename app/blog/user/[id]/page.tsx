...
export default function UserBlogPostPage() {
    ...
    React.useEffect(() => {
        const fetchPost = async () => {
            try {
                const res = await fetch(`http://localhost:5000/api/user-blogs/${id}`)
    ...
    if (!post) {
        return (
            <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center gap-6">
                ...
                <Link href="/blog" className="px-8 py-3 bg-white text-black rounded-full font-bold hover:scale-105 transition-transform">
                    Back to Blog
                </Link>
            </div>
        )
                ...
                <article className="mx-auto max-w-4xl px-6">
                    ...
                    <header className="space-y-8 mb-16">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="text-sm text-zinc-500">Community Author</div>
                            </div>
                        </motion.div>
                    </header>
                    ...
                    >
                        <div
                            ...
                            [&>h3]:text-2xl [&>h3]:font-bold [&>h3]:text-white [&>h3]:mt-8 [&>h3]:mb-3
                            ...
                            [&>blockquote]:border-l-4 [&>blockquote]:border-primary [&>blockquote]:pl-6 [&>blockquote]:italic [&>blockquote]:text-zinc-400
                            [&>code]:bg-white/5 [&>code]:px-2 [&>code]:py-1 [&>code]:rounded [&>code]:text-sm [&>code]:text-primary
                            [&>pre]:bg-white/5 [&>pre]:p-4 [&>pre]:rounded-xl [&>pre]:overflow-x-auto [&>pre]:mb-6"
                    ...
                    <footer className="mt-24 pt-12 border-t border-white/10 text-center">
                        <Link href="/blog" className="inline-flex items-center gap-3 text-zinc-400 hover:text-white transition-colors group">

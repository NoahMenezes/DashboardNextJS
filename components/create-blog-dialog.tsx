...
export function CreateBlogDialog({ onBlogCreated }: CreateBlogDialogProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await apiClient.post('http://localhost:5000/api/blogs', {
                title,
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button
                    className="bg-white hover:bg-zinc-200 text-black px-6 py-6 rounded-2xl font-bold flex items-center gap-2 shadow-lg hover:shadow-white/10 transition-all"
                >
            ...
            <DialogContent className="bg-zinc-900 border-white/10 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 mt-4">
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-zinc-500">
                            Tip: You can use HTML tags like &lt;h1&gt;, &lt;p&gt;, &lt;strong&gt;, &lt;em&gt;, etc.
                        </p>
                    </div>

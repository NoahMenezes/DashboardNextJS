...
export function UserBlogsSection({ showCreateButton = true, userId, title = "Community Blogs" }: UserBlogsSectionProps) {
    ...
    const fetchBlogs = React.useCallback(async () => {
        try {
            ...
            const endpoint = userId 
                ? `http://localhost:5000/api/user-blogs/user/${userId}`
            ...
            <div className="mx-auto max-w-7xl px-6">
                ...
                {blogs.length === 0 ? (
                    <div className="text-center py-16">
                        ...
                        <p className="text-zinc-400 mb-6">Be the first to share your story!</p>
                        ...
                        >
                            {blogs.map((blog) => (
                                <div key={blog.id} className="relative group">
                                    <Link href={`/blog/user/${blog.id}`} className="block">
